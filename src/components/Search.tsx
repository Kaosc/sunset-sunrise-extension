...
export default function Search({
	...
	return (
		<div className="relative flex flex-row w-60 h-10 mb-5 items-center justify-center rounded-full bg-zinc-800 focus:ring-2 focus:ring-slate-500 focus:ring-opacity-50 hover:bg-zinc-700">
			<button
